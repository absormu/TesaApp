...
//        File file = new File("C://tesaapp/report/Lap_Pembayaran_Sewa.jrxml"); 
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Menu Cetak Pembayaran Sewa");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try { 
            ...
            Logger.getLogger(Cetak_Pembayaran_Sewa.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cetak_Pembayaran_Sewa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cetak_Pembayaran_Sewa().setVisible(true);
            }
        });
    }
